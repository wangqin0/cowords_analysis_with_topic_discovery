...
lda_input_corpus = corpus
lda_input_id2word = id2word
...
print(lemmatizer_input)
print(bigram_input)
print(dictionary_input)
print(lda_input_corpus)
print(lda_input_id2word)
